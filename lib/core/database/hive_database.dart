...
class HiveDatabase {
  ...
  Future<void> init() async {
    ...
    try {
      ...
      AppLogger.error(
          'Failed to initialize Hive', e, stackTrace, 'HiveDatabase');
      rethrow;
    }
  }
  ...
  Future<Box<T>> openBox<T>(String boxName) async {
    if (!_initialized) {
      throw StateError(
          'Hive not initialized. Call HiveDatabase.instance.init() first.');
    }
    ...
    try {
      ...
      AppLogger.error(
          'Failed to open box: $boxName', e, stackTrace, 'HiveDatabase');
      rethrow;
    }
  }
  ...
  Future<LazyBox<T>> openLazyBox<T>(String boxName) async {
    ...
    try {
      ...
      AppLogger.error(
          'Failed to open lazy box: $boxName', e, stackTrace, 'HiveDatabase');
      rethrow;
    }
  }
  ...
  Future<void> closeBox(String boxName) async {
    try {
      ...
      AppLogger.error(
          'Failed to close box: $boxName', e, stackTrace, 'HiveDatabase');
    }
  }
  ...
  Future<void> closeAll() async {
    try {
      ...
      AppLogger.error(
          'Failed to close Hive boxes', e, stackTrace, 'HiveDatabase');
    }
  }
  ...
  Future<void> deleteBox(String boxName) async {
    try {
      ...
      AppLogger.error(
          'Failed to delete box: $boxName', e, stackTrace, 'HiveDatabase');
    }
  }
  ...
  Future<void> clearAllData() async {
    try {
      ...
      AppLogger.error(
          'Failed to clear Hive data', e, stackTrace, 'HiveDatabase');
    }
  }
}
